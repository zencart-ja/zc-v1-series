...
UPDATE configuration SET configuration_title='納品書への注文のコメント表示', configuration_description='納品書に注文のコメント欄を表示しますか?\r\n<br />\r\n・0= いいえ<br />\r\n・1= 一つ目のコメントのみ表示<br />\r\n・2= 全てのコメントを表示' WHERE configuration_key='ORDER_COMMENTS_INVOICE';
UPDATE configuration SET configuration_title='配送表への注文のコメント表示', configuration_description='配送表に注文のコメント欄を表示しますか?\r\n<br />\r\n・0= いいえ<br />\r\n・1= 一つ目のコメントのみ表示<br />\r\n・2= 全てのコメントを表示' WHERE configuration_key='ORDER_COMMENTS_PACKING_SLIP';
...
UPDATE configuration SET configuration_title='「カートに入れる」ボタンの表示', configuration_description='「カートに入れる」ボタンを表示するかどうかを設定します。<br /><br />\r\n・0= いいえ<br />\r\n・1= はい<br />\r\n・2= はい、商品の個数欄と共に表示します。 <br /><strong>注意:</strong> 数量欄の表示をいいえにしていたり、オプションを設定している際は表示されません。' WHERE configuration_key='PRODUCT_LIST_PRICE_BUY_NOW';
...
UPDATE configuration SET configuration_title='商品リストの英語名でのソートボタン', configuration_description='商品リストに英語名でのソートボタンを表示しますか?\r\n<br />\r\n・true (する)<br />\r\n・false (しない)' WHERE configuration_key='PRODUCT_LIST_ALPHA_SORTER';
UPDATE configuration SET configuration_title='商品リストのサブカテゴリ画像', configuration_description='商品リストのサブカテゴリで画像を表示しますか?\r\n<br />\r\n・true (する)<br />\r\n・false (しない)' WHERE configuration_key='PRODUCT_LIST_CATEGORIES_IMAGE_STATUS';
UPDATE configuration SET configuration_title='商品リストのトップカテゴリ画像', configuration_description='商品リストのトップカテゴリで画像を表示しますか?\r\n<br />\r\n・true (する)<br />\r\n・false (しない)' WHERE configuration_key='PRODUCT_LIST_CATEGORIES_IMAGE_STATUS_TOP';
UPDATE configuration SET configuration_title='トップカテゴリ内サブカテゴリのリンク表示', configuration_description='トップカテゴリページでサブカテゴリのリンクを表示するかどうか設定します。<br />\r\n・0=非表示<br />\r\n・1=表示' WHERE configuration_key='PRODUCT_LIST_CATEGORY_ROW_STATUS';
...
UPDATE configuration SET configuration_title='ショッピングカートが空の場合の新着商品の表示', configuration_description='ショッピングカートが空の場合の新着商品の表示を設定します。<br /><br />\r\n・0= off' WHERE configuration_key='SHOW_SHOPPING_CART_EMPTY_NEW_PRODUCTS';
UPDATE configuration SET configuration_title='ショッピングカートが空の場合のおすすめ商品の表示', configuration_description='ショッピングカートが空の場合のおすすめ商品の表示を設定します。。<br /><br />\r\n・0= off' WHERE configuration_key='SHOW_SHOPPING_CART_EMPTY_FEATURED_PRODUCTS';
UPDATE configuration SET configuration_title='ショッピングカートが空の場合の特価商品の表示', configuration_description='ショッピングカートが空の場合の特価商品の表示を設定します。<br /><br />\r\n・0= off' WHERE configuration_key='SHOW_SHOPPING_CART_EMPTY_SPECIALS_PRODUCTS';
UPDATE configuration SET configuration_title='ショッピングカートが空の場合の入荷予定商品の表示', configuration_description='ショッピングカートが空の場合の入荷予定商品の表示を設定します。<br /><br />\r\n・0= off' WHERE configuration_key='SHOW_SHOPPING_CART_EMPTY_UPCOMING';
UPDATE configuration SET configuration_title='ログイン時のショッピングカートへの動作', configuration_description='ログインする前にカートに商品を入れたままにしていた際、次回のログイン時のショッピングカートの動作を設定します。<br /><br />0= 動作しない<br />1= 動作し、通知を行わずに直接ショッピングカートへ<br />3= 動作し、通知を行うだけでショッピングカートへはいかない' WHERE configuration_key='SHOW_SHOPPING_CART_COMBINED';
...
UPDATE configuration SET configuration_title='クレジットカード利用の可否 - SOLO', configuration_description='SOLOを有効にしますか?<br /><br />\r\n・0= off<br />\r\n・1= on' WHERE configuration_key='CC_ENABLED_SOLO';
UPDATE configuration SET configuration_title='クレジットカード利用の可否 - Switch', configuration_description='Switchを有効にしますか?<br /><br />\r\n・0= off<br />\r\n・1= on' WHERE configuration_key='CC_ENABLED_SWITCH';
UPDATE configuration SET configuration_title='クレジットカード利用の可否 - Maestro', configuration_description='Maestroを有効にしますか?<br /><br />\r\n・0= off<br />\r\n・1= on' WHERE configuration_key='CC_ENABLED_MAESTRO';
...
UPDATE configuration SET configuration_title='METAタグ - TITLEタグへの商品型番表示', configuration_description='TITLEタグに商品型番を表示しますか?<br />\r\n<br />\r\n・0= off<br />\r\n・1= on' WHERE configuration_key='META_TAG_INCLUDE_MODEL';
...
UPDATE configuration SET configuration_title='[前へ] [次へ] - カテゴリ名と画像の状態', configuration_description='[前へ] [次へ] のカテゴリの画像と名称の状態は?<br /><br />\r\n・0= カテゴリ名と画像を常に表示<br />\r\n・1= カテゴリ名のみ表示<br />\r\n・2= カテゴリ名と画像は空でない表示場合<br />\r\n・3= 右に配置' WHERE configuration_key='PRODUCT_INFO_CATEGORIES_IMAGE_STATUS';
...
UPDATE configuration SET configuration_title='入荷予定商品の新着表示', configuration_description='入荷予定商品を新着、サイドボックスに表示しますか?<br />0= off<br />1= on' WHERE configuration_key='SHOW_NEW_PRODUCTS_UPCOMING_MASKED';
